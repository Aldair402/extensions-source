...
class LectorTmo :
    ...
    private fun getSFWUrlPart(): String = if (getSFWModePref()) "&exclude_genders%5B%5D=19&exclude_genders%5B%5D=17&exclude_genders%5B%5D=18&exclude_genders%5B%5D=19&exclude_genders%5B%5D=94&erotic=false" else ""
    ...
    // on ${baseUrl}/biblioteca
    // Last revision 15/06/2026 (mm/dd/yyyy)
    private fun getGenreList() = listOf(
        ...
        Genre("Misterio", "7"),
        Genre("Romance", "8"),
        Genre("Ciencia Ficción", "9"),
        Genre("Slice of Life", "10"),
        Genre("Deportes", "11"),
        Genre("Sobrenatural", "12"),
        Genre("Thriller", "13"),
        Genre("Histórico", "14"),
        Genre("Psicológico", "15"),
        Genre("Isekai", "16"),
        Genre("Mecha", "17"),
        Genre("Escolar", "18"),
        Genre("Ecchi", "19"),
        Genre("Harem", "20"),
        Genre("MangoScan", "21"),
        Genre("Recuentos de la vida", "22"),
        Genre("Shoujo", "23"),
        Genre("Regresion", "24"),
        Genre("Familia", "25"),
        Genre("Magia", "26"),
        Genre("+18", "27"),
        Genre("Vida Escolar", "28"),
        Genre("Smut", "29"),
        Genre("Boys Love", "30"),
        Genre("Yaoi", "31"),
        Genre("Adulto", "32"),
        ...
        Genre("Girls Love", "35"),
        Genre("Reencarnación", "36"),
        Genre("Tragedia", "37"),
        Genre("Transmigración", "38"),
        Genre("Sistema", "39"),
        Genre("Harem Inverso", "40"),
        Genre("Artes Marciales", "41"),
        Genre("Shonen", "42"),
        Genre("Militar", "43"),
        Genre("Gore", "44"),
        Genre("Bender", "45"),
        Genre("Deporte", "46"),
        Genre("Apocalíptico", "47"),
        Genre("Supervivencia", "48"),
        Genre("Realidad Virtual", "49"),
        Genre("Demonios", "50"),
        Genre("Josei", "51"),
        Genre("Yuri", "52"),
        Genre("Seinen", "53"),
        Genre("Género Bender", "54"),
        Genre("Historia", "55"),
        Genre("Parodia", "56"),
        Genre("Vampiros", "57"),
        Genre("Superpoderes", "58"),
        Genre("Samurái", "59"),
        Genre("Niños", "60"),
        Genre("Realidad", "61"),
        Genre("Ciberpunk", "62"),
        ...
        Genre("Webcomic", "72"),
        Genre("Shounen", "73"),
        Genre("reencuentro de la vida", "74"),
        Genre("sobre natural", "75"),
        Genre("Action", "76"),
        Genre("Adventure", "77"),
        Genre("Fantasy", "78"),
        Genre("Gender Bender", "79"),
        Genre("BL (Boys Love)", "80"),
        Genre("Adult Cast", "81"),
        Genre("Urban Fantasy", "82"),
        Genre("Comedy", "83"),
        Genre("School", "84"),
        Genre("Music", "85"),
        Genre("Novela", "86"),
        Genre("Historical", "87"),
        Genre("Mythology", "88"),
        Genre("Award Winning", "89"),
        Genre("Military", "90"),
        Genre("Gourmet", "91"),
        Genre("Doujinshi", "92"),
        Genre("Español", "93"),
        Genre("Shonen-ai", "94"),
        Genre("Shonen-ai (Yaoi Soft)", "95"),
        Genre("Yaoi (Soft)", "96"),
        Genre("Super Natural", "97"),
        Genre("Fantasía urbana", "98"),
        Genre("Sports", "99"),
        Genre("Team Sports", "100"),
        Genre("Psychological", "101"),
        Genre("Mystery", "102"),
        Genre("Vampire", "103"),
        Genre("Oneshot", "104"),
        Genre("Vida Cotidiana", "105"),
        Genre("Manhwa", "106"),
        Genre("Manga", "107"),
        ...
        Genre("Webtoon", "114"),
        Genre("ficcion", "115"),
        Genre("Video Game", "116"),
        Genre("Ejercito", "117"),
        Genre("Sistema de Niveles", "118"),
        Genre("Reincarnation", "119")
    )
